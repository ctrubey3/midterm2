...
function UserInfo(props){
    const objectInfo= [{id:0},
        {name:"Goku", category:"animation", value:1, id:1, img: "https://images-na.ssl-images-amazon.com/images/I/51KJqhhcMZL._AC_SL1076_.jpg"    },
    ...
    let category =objectInfo[id].category;
    let value = objectInfo[id].value;
...
<div> <Link to={"/"}>Go Back</Link>
        ...
        <div className="c-list__Funk"  style={styleLink} key={id}>
            <button>
                <h5>Name:{name}</h5>
